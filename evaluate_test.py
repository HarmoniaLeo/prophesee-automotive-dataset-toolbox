...
pred1=np.array([
       [666300, 258.19247, 339.60562, 192.10843, 151.78035, 0, 0.994329, 68],
       [666300, 887.2574 , 327.16568, 493.80017, 213.28908, 1, 0.978683, 0],
       [666300, 505.3598 , 331.8377 , 166.55472, 149.18884, 0, 0.995899, 0],
       ])
pred2=np.array([
       [6663008, 257.19247, 339.60562, 192.10843, 151.78035, 0, 0.994329, 68],
       [6663008, 887.2574 , 327.16568, 493.80017, 213.28908, 1, 0.978683, 0],
       [6663008, 505.3598 , 331.8377 , 166.55472, 149.18884, 0, 0.995899, 0],
       ])
pred3=np.array([
       [666300800, 266.19247, 339.60562, 192.10843, 151.78035, 0, 0.994329, 68],
       [666300800, 887.2574 , 327.16568, 493.80017, 213.28908, 1, 0.978683, 0],
       [666300800, 505.3598 , 331.8377 , 166.55472, 149.18884, 0, 0.995899, 0],
       ])
        #,dtype=[('t', '<u8'), ('x', '<f4'), ('y', '<f4'), ('w', '<f4'), ('h', '<f4'), ('class_id', 'u1'), ('class_confidence', '<f4'), ('track_id', '<u4')])

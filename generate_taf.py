...
for mode in ["train","val","test"]:
    ...
    for i_file, file_name in enumerate(files):
        ...
        for bbox_count,unique_time in enumerate(unique_ts):
            ...
            c = np.fromfile(file_name+"_"+str(unique_time)+ "_c.npy",dtype=np.int8)
            y = np.fromfile(file_name+"_"+str(unique_time)+ "_y.npy",dtype=np.int16)
            x = np.fromfile(file_name+"_"+str(unique_time)+ "_x.npy",dtype=np.int16)
            p = np.fromfile(file_name+"_"+str(unique_time)+ "_p.npy",dtype=np.bool_)
            features = np.fromfile(file_name+"_"+str(unique_time)+ "_f.npy",dtype=float)

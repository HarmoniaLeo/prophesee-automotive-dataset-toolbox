...
if __name__ == '__main__':
    ...
    if args.dataset == "gen1":
        ...
        "gen4_basic_frame1000000","gen4_basic_leaky1e5","gen4_basic_leaky2.5e6","gen4_basic_leaky1e6","gen4-taf2","gen4-taf_tcn_connect2","gen4_taf_bins8","gen4_taf_tcn_connect_bins8"]
        result_paths = []
        for exp_name in exp_names:
